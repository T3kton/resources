...
echo "** Use /usr/lib/contractor/resources/proxmoxExtractISO to load Proxmox ISO image **"
...
/usr/lib/contractor/util/blueprintLoader ${1}usr/lib/contractor/resources/promox.toml
